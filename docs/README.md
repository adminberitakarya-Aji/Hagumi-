...
| [**02. Mekanika Permainan & Sistem Pertumbuhan (02_GAMEPLAY_MECHANICS.md)**](./02_GAMEPLAY_MECHANICS.md) | 6 status vital & siklus peluruhan (*decay*), formula pertumbuhan EXP eksponensial, 5 fase evolusi ekor (*Kitsune Morphosis*), formula *Care Score*, dan sistem ikatan batin (*Kizuna*). |
