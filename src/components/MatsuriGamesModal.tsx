...
import { X, Trophy, Coins, RotateCcw, Play, Heart, Sparkles, Award } from 'lucide-react';
...
export const MatsuriGamesModal: React.FC<MatsuriGamesModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 overflow-y-auto animate-in fade-in">
      <div className="relative w-full max-w-2xl bg-gradient-to-b from-[#251e18] via-[#1a1512] to-[#120e0b] text-stone-100 rounded-3xl p-4 sm:p-6 shadow-2xl border-2 border-amber-600/70 max-h-[95vh] flex flex-col">
        {/* Header */}
