...
import { ambientBgm } from './sound/ambientBgm';
import type { AmbientBgmApi } from './sound/ambientBgm';
...
export class HagumiAudioEngine {
  ...
  public bgmMasterGain: GainNode | null = null;
  public bgmTimer: number | null = null;
  public currentPhase: DayPhase = 'noon';
  public currentSeason: SeasonType = 'spring';
  public bgmVolume: number = 0.14;
  public stepIndex: number = 0;
  public phraseStepCount: number = 0;
  public targetPhraseLength: number = 10;
  public isZenPausing: boolean = false;
  public droneOsc1: OscillatorNode | null = null;
  public droneOsc2: OscillatorNode | null = null;
  public droneGain: GainNode | null = null;
  ...
  public createNoiseBuffer(duration: number): AudioBuffer | null {
...
// ============================================================
export interface HagumiAudioEngine extends UiSeasonSfx, AmbientBgmApi {}

Object.assign(HagumiAudioEngine.prototype, uiSeasonSfx, ambientBgm);
